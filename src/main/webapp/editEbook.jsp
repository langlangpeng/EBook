...
<form id="form1" name="form1" method="post" action="updateeditebook" >
    <table class="tg" style="width: 800px">
        ...
        <tr>
            ...
            <td class="tg-c3ow"><input readonly type="text" name="title" id="title" value="${ebookEntry.title}" style="color: red"></td>
        </tr>
        <tr>
            <td class="tg-c3ow" style="width: 300px">图书摘要</td>
            <td class="tg-c3ow"><input type="text" name="summary" id="summary" value="${ebookEntry.summary}"></td>
        </tr>
        <tr>
            <td class="tg-c3ow" style="width: 300px">上传人</td>
            <td class="tg-c3ow"><input type="text" name="uploaduser" id="uploaduser" value="${ebookEntry.uploaduser}"></td>
        </tr>
        <tr>

            <td class="tg-c3ow" style="width: 300px">上传时间(*)</td>
            <td class="tg-c3ow"><input type="date" name="createdate" id="createdate" value="${ebookEntry.createdate}"></td>
        </tr>
        <tr>
